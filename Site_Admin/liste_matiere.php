  ...
  <body style="background-color:#979A9A;">
      <nav class="navbar navbar-light bg-dark">
        <div class="container-fluid ">
            ...
            <h1><a class="navbar-brand text-light ml-auto" href="add_matiere.php?var1=Scientifiques">Ajouter une matière</a></h1>
        </div>
      </nav>
      <style>
          .ml-auto{
	        ...
	        <div class="row">
				<div class="col-lg-12 btn btn-dark boutton" style="margin:20px;">
				    <button  type="button" class="btn btn-dark boutton">
				      <h1><b class="nom"><?php echo htmlspecialchars($row['nom']); ?></b> </h1>
				    </button>
                    <script type="text/javascript">
                        ...
                        function ajout(){window.location.href = "liste_epreuve.php?var1=" + this.querySelector('.nom').innerText;}
                    </script>
