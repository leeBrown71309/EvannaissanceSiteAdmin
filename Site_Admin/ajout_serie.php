        ...
        <form action="" method="post">
            <div class="tt row text-center">
                <div class="ff col-lg-3 col-md-3 col-sm-12 text-center">
                    <h2 class="text-light"><label>Nom de la serie:</label></h2>
                </div>
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <input type="text" name="nom" class="form-control" placeholder="Saisir nom de la serie"/>
                </div>
           ...
           <?php
                if(isset($_POST['btn_ajout'])){
                    ...
                    $id_bac = $ab['id_bac'];
                    $query = $db->prepare("INSERT INTO Serie(id_serie,id_bac,nom) VALUES(NULL,'$id_bac','$nom')");
                    $query->execute();
                }
           ?>
        </form>
