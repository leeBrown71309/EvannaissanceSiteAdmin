<?php 
    ...
    $les_matieres = $db->query("select * from Matiere where Matiere.id_bac='$iddd'");
?>
...
<html lang="en">
  ...
  <body style="background-color:#979A9A;">
    ...
    <div class="row text-center">
        <div class="col">
            <h1>Liste des Matieres <?php echo $_GET['var1'];?></h1>
            <hr>
        </div>
    </div>
	<div class="container text-center">
	    <?php while($row = $les_matieres->fetch(PDO::FETCH_ASSOC)) : ?>
	        <div class="row">
				<div class="col-lg-12 btn btn-dark boutton" style="margin:20px;">
				    <button  type="button" class="btn btn-dark boutton">
				      <h1><b class="nom <?php echo $_GET['var1'];?>"><?php echo htmlspecialchars($row['nom']); ?></b> </h1>
				    </button>
                    <script type="text/javascript">
                        ...
                        function ajout(){window.location.href = "get.php?var1=" + this.querySelector('b').innerText+"&var2="+this.querySelector('b').classList[1];}
                    </script>
